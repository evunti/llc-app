    ...
    <div className="relative font-sans min-h-screen">
      <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20">
        <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
          <h1 className="text-4xl font-bold text-center">GRL Solution – Great Leather Repair Solution</h1>
          <h2 className="text-2xl text-center text-gray-700">Expert Leather Repair & Reupholstery in Harrisonburg, VA</h2>
          ...
          <a href="/contact" className="mt-4 px-6 py-3 bg-[#2a2b2b] text-white rounded shadow hover:bg-[#444] transition">Request a Free Estimate</a>
        </main>
