...
export function NavBar() {
  ...
  return (
    <nav className="w-full flex justify-center mb-2 relative px-0 z-20">
      <div className="w-full flex items-center justify-center relative min-h-[38px] md:bg-[#2a2b2b]/95 md:border-b-2  md:shadow-sm">
        {/* Desktop nav */}
        ...
        <div className="md:hidden absolute right-2 top-1 flex items-center h-full">
          ...
          >
            <span
              className="w-6 h-[1.5px] bg-black mb-[5px]"
            ...
            ></span>
            <span
              className="w-6 h-[1.5px] bg-black"
              style={{ borderRadius: 0 }}
            ></span>
          </button>
        </div>
